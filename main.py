...
append_flag = False
top_y, bottom_y = 160, 200
left_x, right_x = 560, 700

darkpurple = (94, 66, 129)
toleranceForAnyColor = 20
red_thresholds = {"min_r": 201, "max_g": 199, "max_b": 199}
green_thresholds = {"min_r": 100, "max_g": 120, "max_b": 100}

x, y = 1660, 750
upto = 570
oneMoreStaringFromLeft = 50
blackLineLower = [197, 197, 197]
blackLineUpper = [228, 228, 228]
distanceFromBlackLine = 6
yTopAndBottomLimit = 15
target_y = 300
...
def clean_ocr_label(text):
    ...
    return re.sub(r'\s*\d+$', '', clean_text).strip()
