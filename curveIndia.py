...
if __name__ == "__main__":
  input_file = "all_indian_stocks_6mo.csv"
  output_file = "final_screened_indian_stocks.csv"
  ...
  export_chunks(
      df=df_without_ath,
      folder_path="indian_output_excels/without_ath",
      file_prefix="indian_stocks_without_ath_new",
      is_new_status="Yes",
  )
  ...
  export_chunks(
      df=df_without_ath,
      folder_path="indian_output_excels/without_ath_non_new",
      file_prefix="indian_stocks_without_ath_non_new",
      is_new_status="No",
  )
  ...
  export_chunks(
      df=df_with_ath,
      folder_path="indian_output_excels/with_ath",
      file_prefix="indian_stocks_with_ath_new",
      is_new_status="Yes",
  )
  ...
  export_chunks(
      df=df_with_ath,
      folder_path="indian_output_excels/with_ath_non_new",
      file_prefix="indian_stocks_with_ath_non_new",
      is_new_status="No",
  )
